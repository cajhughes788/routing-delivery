# This is a list of all delivery addresses used in the program.
# The order of this list matches the rows and columns of the distance table below.
address_list = [
    "4001 South 700 East",
    "1060 Dalton Ave S",
    "1330 2100 S",
...
# This is a 2D list (matrix) that holds the distances between each address.
distance_table = [
...
# This function returns the distance between two addresses using the distance table.
# It looks up the position of each address in the address_list and gets the distance.
def get_distance(from_address, to_address):
    i = address_list.index(from_address)
    j = address_list.index(to_address)
